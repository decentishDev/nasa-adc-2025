Shader "Custom/Atmosphere" 
{
    Properties
    {
        ...
        _LightColor("Light Color", Color) = (0.6,0.7,1)  // Slightly bluish light color
        ...
        _RayleighScattering("Rayleigh Scattering", Vector) = (0.15, 0.3, 0.6, 0.5) // Increased blue component
